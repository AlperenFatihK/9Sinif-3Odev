...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (hiç değilse birkaç frame benim ölçümlerinden farklı olsun.) Kullandığınız Google Sheet için [buraya](https://docs.google.com/spreadsheets/d/12Jq5M6HRSGNTLGLWINGxxM9P5Zc8UAJdXd02iA2koMo/edit) link verin (Google Sheet herkese açık erişimli olsun.) 

a) Denkleminizi **buraya yazınız**   -1,08X^2+1,83x-0,0993   . Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? (Cevap yok, bulamadım.)  Sizce niçin a'nın değeri negatif?  Cisim yavaşlayan bir hareket yapıp sonda durduğu için a negatiftir.
b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir? (Evet, sabittir) 
c) Video'daki cismin atılış hızı farklı olsaydı (diğer herşey aynı, kütle, yüzey, vb. Hava sürtünmesini ihmal edin), sizce formülde hangi terimler değişecekti? (a, b veya c)  Bence, yalnız c değişirdi.
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/1NwG4Qq8-jSgMamXXFQIxpy-BSH1G3K6UW_ibvnXHAmQ/edit) link veriniz.
...
3) İvme'yi ne buldunuz? Bu ivme değerini kullanarak 1kg'lık cisim ile yüzey arasındaki kinetik sürtünme katsayısını bulunuz.  İvmeyi -2,23 buldum, kinetik sürtünme katsayısını da 0,223 buldum

# Bölüm 3 (Hala Beni Öldürmeyi Düşünmüyorsan)
1) Bu deneyde ölçüm hatalarım var. Zamandaki ölçüm hatam sizce kaç ms (mili saniye) nedir? Konumdaki ölçüm hatam sizce kaç cm'dir?  (Yapamadım)
...
3) Bu video'dan statik sürtünme katsayısını bulabilir miydim?  Bence bulabilirdik ama işlemlerimde sorun var bulamadım :(
